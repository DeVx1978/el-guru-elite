  ...
  return (
    <div className="elite-landing-master">
      ...
      <section className="hero-elite">
        <div className="hero-content">
          ...
          <div className="hero-cta-btn-group">
            ...
            <button onClick={(e) => ejecutarTransicion(e, '/login')} className="btn-hero-secondary mobile-only">ACCESO <Lock size={16} /></button>
          </div>
        </div>
      ...
      <style jsx global>{`
        ...
        .mobile-link { color: white; font-size: 1.6rem; font-weight: 900; text-transform: uppercase; letter-spacing: 4px; cursor: pointer; }

        .hero-elite { max-width: 1400px; margin: 0 auto; padding: 40px 20px; display: flex; flex-direction: column; }
        @media (min-width: 1024px) { .hero-elite { padding: 80px 30px; min-height: 85vh; justify-content: center; } .hero-content { text-align: left; max-width: 1000px; } }
        ...
        .hero-cta-btn-group { display: flex; flex-direction: row; gap: 10px; width: 100%; }
        .btn-hero-primary { background: var(--neon); color: black; border: none; padding: 18px 25px; border-radius: 4px; font-weight: 900; flex: 1.2; display: flex; justify-content: center; align-items: center; gap: 10px; font-size: 0.85rem; }
        .btn-hero-secondary { background: transparent; border: 1px solid var(--neon); color: var(--neon); padding: 18px 15px; border-radius: 4px; font-weight: 900; flex: 0.8; display: flex; justify-content: center; align-items: center; gap: 10px; font-size: 0.8rem; }
        @media (min-width: 1024px) { .hero-cta-btn-group { width: auto; } .btn-hero-primary { flex: none; width: 280px; padding: 22px; font-size: 1.1rem; } .mobile-only { display: none !important; } }
