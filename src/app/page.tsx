...
export default function LandingPage() {
  ...
  const navegarPrivado = (e: React.MouseEvent) => {
    e.preventDefault();
    setIsNavigating(true); // ← Activa overlay de navegación
    router.push('/panel');
  };

  // Overlay limpio durante navegación (elimina flash de "Bienvenido")
  if (isNavigating) {
    return (
      <div style={{
        position: 'fixed',
        ...
        <div className="loader-container" style={{ width: 220, height: 220 }}>
          <div className="pulse-ring"></div>
          <div className="image-wrapper">
            <img src="/images/guru.jpg" alt="Cargando" style={{ width: '100%', height: '100%', objectFit: 'cover' }} />
          </div>
        </div>
      </div>
    );
  ...
  // Loader inicial (la imagen del Guru SOLO aparece aquí)
  if (loading) {
    return (
  ...
  // ====================== Resto del código ORIGINAL sin ningún cambio ======================
  const membresias = [
  ...
  return (
    <div className="elite-landing-master">
      ...
      {/* TODOS LOS ESTILOS ORIGINALES SIN NINGÚN CAMBIO */}
      <style jsx global>{`
        ...
        .nav-container-master {
          max-width: 1300px; margin: 0 auto; padding: 22px 30px;
        ...
        .hero-visuals-right { position: relative; display: flex; justify-content: center; align-items: center; height: 450px; }
