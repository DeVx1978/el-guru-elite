    ...
    <div className="elite-landing-master">
      ...
      <section className="hero-elite">
        <div className="hero-content">
          ...
          {/* BOTONES CORREGIDOS - lado a lado en móvil y desktop */}
          <div className="hero-cta-btn-group">
            ...
            <button onClick={(e) => ejecutarTransicion(e, '/login')} className="btn-hero-secondary">ACCESO VIP <Lock size={16} /></button>
          </div>
        </div>
      ...
      <style jsx global>{`
        ...
        /* === BOTONES HERO CORREGIDOS - lado a lado en móvil y desktop === */
        .hero-cta-btn-group { display: flex; gap: 12px; width: 100%; max-width: 520px; margin: 0 auto; flex-wrap: wrap; }
        .btn-hero-primary { background: var(--neon); color: black; border: none; padding: 18px; border-radius: 4px; font-weight: 900; flex: 1; font-size: 13px; display: flex; align-items: center; justify-content: center; gap: 8px; min-width: 160px; }
        .btn-hero-secondary { background: transparent; border: 1px solid var(--neon); color: var(--neon); padding: 18px; border-radius: 4px; font-weight: 900; flex: 1; font-size: 13px; display: flex; align-items: center; justify-content: center; gap: 8px; min-width: 140px; }
        ...
        @media (min-width: 1024px) {
          ...
          .hero-cta-btn-group { width: auto; max-width: 520px; justify-content: flex-start; }
          .btn-hero-primary { width: 300px; padding: 22px; font-size: 14px; }
          .btn-hero-secondary { width: 220px; padding: 22px; font-size: 14px; }
        ...
        @media (max-width: 768px) {
          .hero-cta-btn-group { gap: 10px; }
          .btn-hero-primary, .btn-hero-secondary { padding: 16px; font-size: 14px; min-width: 48%; }
