...
export default function LandingPage() {
  ...
  // --- CORRECCIÓN QUIRÚRGICA: ELIMINA EL FLASH DE "BIENVENIDO" ---
  const navegarPrivado = (e: React.MouseEvent) => {
    e.preventDefault();
    e.stopPropagation();
    
    // 1. Forzamos un micro-bloqueo de renderizado para limpiar la vista actual
    // 2. Ejecutamos la navegación nativa de Next.js sin estados intermedios
  ...
  return (
    <div className="elite-landing-master">
      ...
      <style jsx global>{`
        ...
        .footer-links-row-elite { display: flex; justify(center); gap: 60px; margin-bottom: 50px; flex-wrap: wrap; }
