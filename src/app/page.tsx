    ...
    return (
      <div className="splash-master">
        ...
        <div className="welcome-container-luxe">
          ...
          {/* 💉 VERDE INSTITUCIONAL Y TAMAÑO RESTAURADO */}
        ...
        <style jsx global>{`
          ...
          .loading-bar-master { width: 220px; height: 2px; background: rgba(255,255,255,0.03); margin-bottom: 25px; }
    ...
    <div className="elite-landing-master">
        ...
        <div className="info-overlay active">
          <div className="info-page-container">
            ...
            <div className="info-body">
              <div className="info-tag"><Zap size={16} color="#00C853" /> SECCIÓN ÉLITE</div>
      ...
      <nav className="navbar-elite">
        <div className="nav-container-master">
          ...
          <div className="nav-actions-master">
            <button onClick={(e) => ejecutarTransicion(e, '/panel')} className="btn-nav-access desktop-only">ACCESO EXCLUSIVO</button>
      ...
      <section className="hero-elite">
        <div className="hero-content">
          ...
          <p className="hero-subtext">Optimización estratégica de activos mediante algoritmos de IA. Seguridad blindada para inversores de alto perfil.</p>
          <div className="hero-cta-btn-group">
            <button onClick={(e) => ejecutarTransicion(e, '/unete')} className="btn-hero-primary">COMENZAR <ArrowUpRight size={18} /></button>
            <button onClick={(e) => ejecutarTransicion(e, '/panel')} className="btn-hero-secondary mobile-only">ACCESO <Lock size={16} /></button>
          </div>
        </div>
      ...
      <style jsx global>{`
        ...
        .info-page-container { height: 100%; width: 100%; padding: 50px 30px; display: flex; flex-direction: column; }
        ...
        .mobile-link { color: white; font-size: 1.8rem; font-weight: 900; text-transform: uppercase; letter-spacing: 5px; }
