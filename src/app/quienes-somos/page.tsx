  ...
  return (
    <main style={{ backgroundColor: '#020406', minHeight: '100vh', color: 'white', fontFamily: 'Arial', padding: '100px 5%' }}>
      ...
      <section style={{ maxWidth: '800px', margin: '0 auto', textAlign: 'center' }}>
        <h1 style={{ color: '#00C853', fontSize: 'clamp(2rem, 8vw, 3.5rem)', marginBottom: '30px', fontStyle: 'italic', fontWeight: '900' }}>QUIÉNES SOMOS</h1>
        ...
        <div style={{ marginTop: '50px', padding: '40px', background: '#0a0c10', borderRadius: '20px', border: '1px solid #1a1d23' }}>
          <h3 style={{ color: '#00C853', marginBottom: '15px' }}>NUESTRA MISIÓN</h3>
          <p style={{ color: '#888' }}>Llevar la inversión deportiva a un nivel institucional, con transparencia y resultados verificados bajo los más altos estándares de seguridad.</p>
        </div>
      </section>
    </main>
  );
